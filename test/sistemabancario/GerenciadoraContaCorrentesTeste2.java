...
public class GerenciadoraContaCorrentesTeste2 {
	...
	public void testeTransfereValor(){
		...
		boolean transferenciaEfetuada = gerContaCorrentes.transfereValor(1, 200, 2);

		assertThat(transferenciaEfetuada, is(true));
		assertThat(contaCorrente01.getSaldo(), is(-100.0));
		assertThat(contaCorrente02.getSaldo(), is(200.0));
	}
}
